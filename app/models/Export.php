...
class Export extends Eloquent {
  ...
  {
    $results = DB::select('SELECT distinct concat(u.first_name, " ", u.last_name) as name, p.gender, p.state, p.zip, group_concat(r.race) as race, REPLACE(REPLACE(REPLACE(REPLACE(a.activities,CHAR(10)," "),CHAR(13)," "), CHAR(9)," "), CHAR(44),";"), concat("footlockerscholarathletes.com/admin/applications/", u.id) as link
                          FROM users u
