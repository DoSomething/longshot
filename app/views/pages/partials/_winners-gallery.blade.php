    ...
    <article class="card" data-modal="trigger">
      <div class="wrapper">
        ...
        <ul class="media-list media-list--key-value __info">
          <li><strong>Location:</strong> Woodbury, MN</li>
          <li><strong>Sports(s):</strong> Basketball and Soccer</li>
          <li><strong>GPA:</strong> 3.6</li>
          <li><strong>College:</strong> University of North Dakota</li>
        </ul>
      </div>
      <figure>
  ...
  <li data-slide="2">
    <article class="card" data-modal="trigger">
      <div class="wrapper">
        ...
        <ul class="media-list media-list--key-value __info">
          <li><strong>Location:</strong> Bronx, NY</li>
          <li><strong>Sports(s):</strong> Baseball, Soccer, Wrestling</li>
          <li><strong>GPA:</strong> 4.0</li>
          <li><strong>College:</strong> Middlebury College</li>
        </ul>
      </div>
      <figure>
  ...
  <li data-slide="3">
    <article class="card" data-modal="trigger">
      <div class="wrapper">
        ...
        <ul class="media-list media-list--key-value __info">
          <li><strong>Location:</strong> Roanoke Rapids, North Carolina</li>
          <li><strong>Sports(s):</strong> Baseball</li>
          <li><strong>GPA:</strong> 3.9</li>
          <li><strong>College:</strong> University of North Carolina, Chapel Hill</li>
        </ul>
      </div>
      <figure>
    ...
    <article class="card" data-modal="trigger">
      <div class="wrapper">
        ...
        <ul class="media-list media-list--key-value __info">
          ...
          <li><strong>Sports(s):</strong> Volleyball, Cycling, Skiing, Swimming, Water Polo</li>
          <li><strong>GPA:</strong> 3.7</li>
          <li><strong>College:</strong> Baylor University</li>
        </ul>
      </div>
      <figure>
    ...
    <article class="card" data-modal="trigger">
      <div class="wrapper">
        ...
        <ul class="media-list media-list--key-value __info">
          ...
          <li><strong>Sports(s):</strong> Football, Soccer, Weightlifting</li>
          <li><strong>GPA:</strong> 3.9</li>
          <li><strong>College:</strong> Harvard College</li>
        </ul>
      </div>
      <figure>
    ...
    <article class="card" data-modal="trigger">
      <div class="wrapper">
        ...
        <ul class="media-list media-list--key-value __info">
          ...
          <li><strong>Sports(s):</strong> Soccer, Swimming and Diving, Tennis</li>
          <li><strong>GPA:</strong> 3.7</li>
          <li><strong>College:</strong> Texas A&M University, College Station</li>
        </ul>
      </div>
      <figure>
  ...
  <li data-slide="7">
    <article class="card" data-modal="trigger">
      <div class="wrapper">
        ...
        <ul class="media-list media-list--key-value __info">
          <li><strong>Location:</strong> Marietta, Georgia</li>
          <li><strong>Sports(s):</strong> Cross Country, Track and Field</li>
          <li><strong>GPA:</strong> 4.0</li>
          <li><strong>College:</strong> Vanderbilt University</li>
        </ul>
      </div>
      <figure>
  ...
  <li data-slide="8">
    <article class="card" data-modal="trigger">
      <div class="wrapper">
        ...
        <ul class="media-list media-list--key-value __info">
          <li><strong>Location:</strong> Lawrence, Kansas</li>
          <li><strong>Sports(s):</strong> Gymnastics, Track and Field</li>
          <li><strong>GPA:</strong> 4.0</li>
          <li><strong>College:</strong> Washington University in St. Louis</li>
        </ul>
      </div>
      <figure>
    ...
    <article class="card" data-modal="trigger">
      <div class="wrapper">
        ...
        <ul class="media-list media-list--key-value __info">
          ...
          <li><strong>Sports(s):</strong> Football, Track and Field</li>
          <li><strong>GPA:</strong> 4.0</li>
          <li><strong>College:</strong> Dartmouth College</li>
        </ul>
      </div>
      <figure>
      ...
      <div class="__body">Joshua Davis excels in the classroom and on the field. Despite being homeless for most of his childhood, Joshua was able to accomplish an incredible amount, maintaining a GPA above 4.0 during his high school career. Instead of letting his situation get him down, Joshua was inspired by these hardships and now dreams of one day opening a shelter for young people. He wants to support and encourage young people to focus on education and rise above their circumstances, as he has done. Joshua works hard in all areas of his life, and this is reflected through his accomplishment of joining the starting lineup on his school’s varsity football squad during his senior year of high school. He is now a freshman at Dartmouth College.</div>
    </article>
  </li>
  ...
  <li data-slide="10">
    <article class="card" data-modal="trigger">
      <div class="wrapper">
        ...
        <ul class="media-list media-list--key-value __info">
          <li><strong>Location:</strong> Dallas, Texas</li>
          <li><strong>Sports(s):</strong> Soccer</li>
          <li><strong>GPA:</strong> 3.9</li>
          <li><strong>College:</strong> Texas Christian University</li>
        </ul>
      </div>
      <figure>
      ...
      <div class="__body">Karoline VanVoorhis is an exceptional student and soccer player. When Karoline tore her ACL, it was devastating to more than just her team; her family was also going through tough financial times. Instead of giving up on the sport she loved, Karoline went to work and earned enough money to pay for physical therapy. After some time, she gained back enough strength to join her fellow players on the varsity soccer team her senior year. Karoline is a freshman at Texas Christian University and hopes to use her degree to become either a nurse or a doctor.</div>
    </article>
  </li>
    ...
    <article class="card" data-modal="trigger">
      <div class="wrapper">
        ...
        <ul class="media-list media-list--key-value __info">
          ...
          <li><strong>Sports(s):</strong> Cross Country, Track and Field</li>
          <li><strong>GPA:</strong> 4.0</li>
          <li><strong>College:</strong> Fordham University</li>
        </ul>
      </div>
      <figure>
  ...
  <li data-slide="12">
    <article class="card" data-modal="trigger">
      <div class="wrapper">
        ...
        <ul class="media-list media-list--key-value __info">
          <li><strong>Location:</strong> Eagle Point, Oregon</li>
          <li><strong>Sports(s):</strong> Basketball, Cross Country, Soccer, Track and Field</li>
          <li><strong>GPA:</strong> 4.0</li>
          <li><strong>College:</strong> Linfield College</li>
        </ul>
      </div>
      <figure>
      ...
      <div class="__body">Kimberlyann Simpson dealt with a lot of hardship in her life, mostly involving the absence of any parental figures to support her. Kimberlyann found that it’s important to be her own positive influence to do better, and throughout high school, she relied on her own personal drive to push her to be successful in school and on the field. Despite these hardships, Kimberlyann volunteered as much as she could - at a food bank through her church, at blood drives in her school, and through sports-oriented activities for kids in her community. Kimberlyann believed that sportsmanship and teamwork were integral to her being the best athlete she can be in high school. She is now a freshman at Linfield College.</div>
    </article>
  </li>
    ...
    <article class="card" data-modal="trigger">
      <div class="wrapper">
        ...
        <ul class="media-list media-list--key-value __info">
          ...
          <li><strong>Sports(s):</strong> Track and Field, Volleyball</li>
          <li><strong>GPA:</strong> 3.9</li>
          <li><strong>College:</strong> St. Olaf University</li>
        </ul>
      </div>
      <figure>
  ...
  <li data-slide="14">
    <article class="card" data-modal="trigger">
      <div class="wrapper">
        ...
        <ul class="media-list media-list--key-value __info">
          <li><strong>Location:</strong> Dover, New Jersey</li>
          <li><strong>Sports(s):</strong> Track and Field, Soccer, Volleyball</li>
          <li><strong>GPA:</strong> 4.0</li>
          <li><strong>College:</strong> Harvard University</li>
        </ul>
      </div>
      <figure>
      ...
      <div class="__body">In high school, Maria Brouard was a three-sport athlete and a five-star student. The confidence she gained through sports – track and field, soccer, and volleyball – inspired Maria to start a tutoring club with a friend. Together, they offered tutoring on any subject three days a week and certified other students to become peer-tutors as well. Maria was ranked #1 in her class and attends Harvard University where she studies biomedical engineering.</div>
    </article>
  </li>
    ...
    <article class="card" data-modal="trigger">
      <div class="wrapper">
        ...
        <ul class="media-list media-list--key-value __info">
          ...
          <li><strong>Sports(s):</strong> Basketball, Cross Country, Football, Track and Field</li>
          <li><strong>GPA:</strong> 3.8</li>
          <li><strong>College:</strong> University of Texas at Austin</li>
        </ul>
      </div>
      <figure>
  ...
  <li data-slide="16">
    <article class="card" data-modal="trigger">
      <div class="wrapper">
        ...
        <ul class="media-list media-list--key-value __info">
          <li><strong>Location:</strong> Stone Mountain, Georgia</li>
          <li><strong>Sports(s):</strong> Basketball, Volleyball</li>
          <li><strong>GPA:</strong> 3.9</li>
          <li><strong>College:</strong> Howard University</li>
        </ul>
      </div>
      <figure>
  ...
  <li data-slide="17">
    <article class="card" data-modal="trigger">
      <div class="wrapper">
        ...
        <ul class="media-list media-list--key-value __info">
          <li><strong>Location:</strong> North Las Vegas, Nevada</li>
          <li><strong>Sports(s):</strong> Baseball</li>
          <li><strong>GPA:</strong> 3.9</li>
          <li><strong>College:</strong> University of Notre Dame</li>
        </ul>
      </div>
      <figure>
  ...
  <li data-slide="18">
    <article class="card" data-modal="trigger">
      <div class="wrapper">
        ...
        <ul class="media-list media-list--key-value __info">
          <li><strong>Location:</strong> Nanuet, New York</li>
          <li><strong>Sports(s):</strong> Tennis</li>
          <li><strong>GPA:</strong> 4.0</li>
          <li><strong>College:</strong> Pennsylvania State University</li>
        </ul>
      </div>
      <figure>
  ...
  <li data-slide="19">
    <article class="card" data-modal="trigger">
      <div class="wrapper">
        ...
        <ul class="media-list media-list--key-value __info">
          <li><strong>Location:</strong> Jamaica, New York</li>
          <li><strong>Sports(s):</strong> Track and Field, Rugby, Basketball</li>
          <li><strong>GPA:</strong> 4.0</li>
          <li><strong>College:</strong> University of Notre Dame</li>
        </ul>
      </div>
    ...
    <article class="card" data-modal="trigger">
      <div class="wrapper">
        ...
        <ul class="media-list media-list--key-value __info">
          ...
          <li><strong>Sports(s):</strong> Soccer</li>
          <li><strong>GPA:</strong> 4.0</li>
          <li><strong>College:</strong> Howard Page University</li>
        </ul>
      </div>
      <figure>
