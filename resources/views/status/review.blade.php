    ...
    <section class="segment segment--review -compact">
      ...
      {!! Form::open(['route' => 'review.store', 'class' => 'fragment']) !!}
        ...
        <div class="field-group -checkbox">
          {!! Form::checkbox('documentation', 1, false, ['id' => 'documentation']); !!}
        ...
        <div class="field-group -checkbox">
          {!! Form::checkbox('factual', 1, false, ['id' => 'factual']); !!}
          {!! Form::label('factual', "You confirm that everything written in the application is true and factual.") !!}
          {!! errorsFor('factual', $errors); !!}
        </div>

        <div class="field-group -checkbox">
          {!! Form::checkbox('media_release', 1, false, ['id' => 'media_release']); !!}
          {!! Form::label('media_release', $global_vars->company_name . " and DoSomething Strategic may use your application in any media or public relations campaigns.") !!}
          {!! errorsFor('media_release', $errors); !!}
        </div>

        <div class="field-group -checkbox">
          {!! Form::checkbox('rules', 1, false, ['id' => 'rules']); !!}
